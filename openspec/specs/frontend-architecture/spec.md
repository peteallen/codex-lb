...
document title, authenticated header brand, and password-login brand. The
Dashboard status-bar repository link MUST target
`https://github.com/peteallen/codex-lb`.
