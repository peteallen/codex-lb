...
def _clear_proxy_env(monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setattr(settings_module, "ENV_FILES", ())
...
def test_settings_upstream_websocket_trust_env_auto_detects_proxy_env(monkeypatch):
...
def test_settings_upstream_websocket_trust_env_explicit_false_overrides_proxy_env(monkeypatch):
    _clear_proxy_env(monkeypatch)
    monkeypatch.setenv("https_proxy", "http://127.0.0.1:7890")
