...
describe("StatsGrid", () => {
  it("renders metric cards with values", () => {
    render(
      <StatsGrid
        stats={[
          ...
          { label: "Capacity projection", value: "0.7 / 0.8", meta: "Projected capacity", icon: Flame, trend: SAMPLE_TREND, trendColor: "#ef4444" },
    ...
    expect(screen.getByText("Capacity projection")).toBeInTheDocument();
