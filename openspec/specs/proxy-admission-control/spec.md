...
#### Scenario: Queued bridge requests wait for the response-create gate
...
- **THEN** the request waits for the gate instead of failing with `response_create_gate_timeout`
