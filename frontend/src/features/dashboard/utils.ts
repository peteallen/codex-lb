import { Activity, AlertTriangle, Coins, DollarSign, MessageSquare, type LucideIcon } from "lucide-react";
...
export function buildDashboardView(
  ...
  const { isDark } = resolveDashboardViewOptions(optionsOrIsDark);
